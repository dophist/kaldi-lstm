...
#include "nnet/bd-nnet-lstm-projected.h"
#include "nnet/bd-nnet-transmit.h"
#include "nnet/bd-nnet-time-shift.h"
...
const struct Component::key_value Component::kMarkerMap[] = {
  ...
  { Component::kTransmit, "<Transmit>"},
  { Component::kTimeShift, "<TimeShift>"},
};
...
Component* Component::NewComponentOfType(ComponentType comp_type,
  ...
  switch (comp_type) {
    ...
    case Component::kLstmProjected :
      ...
      break;
    case Component::kTransmit :
      ans = new TransmitComponent(input_dim, output_dim);
      break;
    case Component::kTimeShift :
